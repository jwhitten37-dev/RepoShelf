...
Phase 4.1 introduces a preferred catalog-window coordinator without treating
...
loss, lease expiry, stopped heartbeats, push success, and window closure permit
only lifecycle reconciliation, never deletion.
